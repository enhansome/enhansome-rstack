...
| -------------------------------------------------------------------------------------------------------- | ------------------------ | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| [Rspack](https://github.com/web-infra-dev/rspack) ⭐ 12,887 \| 🐛 226 \| 🌐 Rust \| 📅 2026-09-05         | Bundler                  | <a href="https://npmjs.com/package/@rspack/core"><img src="https://img.shields.io/npm/v/@rspack/core?style=flat-square&colorA=564341&colorB=EDED91" alt="npm version" /></a>     |
| [Rsbuild](https://github.com/web-infra-dev/rsbuild) ⭐ 3,374 \| 🐛 22 \| 🌐 TypeScript \| 📅 2026-09-05   | Build tool               | <a href="https://npmjs.com/package/@rsbuild/core"><img src="https://img.shields.io/npm/v/@rsbuild/core?style=flat-square&colorA=564341&colorB=EDED91" alt="npm version" /></a>   |
| [Rslib](https://github.com/web-infra-dev/rslib) ⭐ 1,007 \| 🐛 30 \| 🌐 TypeScript \| 📅 2026-09-04       | Library development tool | <a href="https://npmjs.com/package/@rslib/core"><img src="https://img.shields.io/npm/v/@rslib/core?style=flat-square&colorA=564341&colorB=EDED91" alt="npm version" /></a>       |
| [Rspress](https://github.com/web-infra-dev/rspress) ⭐ 2,319 \| 🐛 63 \| 🌐 TypeScript \| 📅 2026-09-04   | Static site generator    | <a href="https://npmjs.com/package/@rspress/core"><img src="https://img.shields.io/npm/v/@rspress/core?style=flat-square&colorA=564341&colorB=EDED91" alt="npm version" /></a>   |
...
| [Rstest](https://github.com/web-infra-dev/rstest) ⭐ 493 \| 🐛 52 \| 🌐 TypeScript \| 📅 2026-09-05       | Testing framework        | <a href="https://npmjs.com/package/@rstest/core"><img src="https://img.shields.io/npm/v/@rstest/core?style=flat-square&colorA=564341&colorB=EDED91" alt="npm version" /></a>     |
| [Rslint](https://github.com/web-infra-dev/rslint) ⭐ 454 \| 🐛 45 \| 🌐 Go \| 📅 2026-09-05               | Linter                   | <a href="https://npmjs.com/package/@rslint/core"><img src="https://img.shields.io/npm/v/@rslint/core?style=flat-square&colorA=564341&colorB=EDED91" alt="npm version" /></a>     |
...
* [Meteor](https://github.com/meteor/meteor) ⭐ 44,810 | 🐛 336 | 🌐 JavaScript | 📅 2026-09-04: An ultra-simple environment for building modern web applications with Rspack.
* [Extension.js](https://github.com/extension-js/extension.js) ⭐ 5,139 | 🐛 6 | 🌐 TypeScript | 📅 2026-09-04: Create, develop, build, and preview browser extensions for Chrome, Firefox, and Edge with Rspack.
* [Re.Pack](https://github.com/callstack/repack) ⭐ 1,932 | 🐛 24 | 🌐 TypeScript | 📅 2026-08-31: A toolkit to build your React Native application with Rspack.
...
* [The Boring JavaScript Stack](https://github.com/sailscastshq/boring-stack) ⭐ 501 | 🐛 4 | 🌐 JavaScript | 📅 2026-06-16: An opinionated full-stack JavaScript starter built with Sails.js, Inertia.js, and Rsbuild-powered frontend assets.
...
* [Rshono](https://github.com/rshono/rshono) ⭐ 76 | 🐛 0 | 🌐 TypeScript | 📅 2026-09-03: Minimalist web framework based on Hono, Rspack and React Server Components.
...
* [vue-admin-better](https://github.com/zxwk1998/vue-admin-better) ⭐ 18,922 | 🐛 18 | 🌐 Vue | 📅 2026-09-05: A Vue 3 admin based on Rspack.
...
* [@trapar-waves/react-antd-pro](https://github.com/Trapar-waves/react-antd-pro) ⭐ 4 | 🐛 10 | 🌐 TypeScript | 📅 2026-09-04: A React-based project leveraging Ant Design Pro, TanStack tools, and Rsbuild.
* [@trapar-waves/react-tanstack](https://github.com/Trapar-waves/react-tanstack) ⭐ 4 | 🐛 9 | 🌐 TypeScript | 📅 2026-09-04: A React template leveraging TanStack tools, with TypeScript, Tailwind CSS, and Rsbuild integration.
...
* [@trapar-waves/vue-tailwind](https://github.com/Trapar-waves/vue-tailwind) ⭐ 3 | 🐛 6 | 🌐 Vue | 📅 2026-09-04: A Vue 3 project with Tailwind CSS, Rsbuild and modern development tools.
...
* [@trapar-waves/react-tailwind](https://github.com/Trapar-waves/react-tailwind) ⭐ 0 | 🐛 9 | 🌐 TypeScript | 📅 2026-09-04: A modern UI development template integrating React and Tailwind CSS, with Rsbuild, TypeScript, ESLint.
...
* [@trapar-waves/llm-template](https://github.com/Trapar-waves/llm-template) ⭐ 3 | 🐛 10 | 🌐 TypeScript | 📅 2026-09-04: A template for LLM development integrating AI tools, TypeScript, Zod, and Rslib.
...
* [@unocss/webpack](https://github.com/unocss/unocss/tree/main/packages-integrations/webpack) ⭐ 18,947 | 🐛 132 | 🌐 TypeScript | 📅 2026-09-05: Plugin for UnoCSS.
...
* [code-inspector-plugin](https://github.com/zh-lx/code-inspector) ⭐ 3,016 | 🐛 5 | 🌐 TypeScript | 📅 2026-08-24: Click an element on the page, it can automatically open the editor and position the cursor to the source code of the element.
* [@module-federation/enhanced](https://github.com/module-federation/core/tree/main/packages/enhanced) ⭐ 2,627 | 🐛 75 | 🌐 JavaScript | 📅 2026-09-05: Provides enhanced features for Module Federation.
...
* [@datadog/rspack-plugin](https://github.com/DataDog/build-plugins) ⭐ 110 | 🐛 30 | 🌐 TypeScript | 📅 2026-09-05: A Rspack plugin to interact with Datadog from your builds.
...
* [html-rspack-plugin](https://github.com/rstackjs/html-rspack-plugin) ⭐ 19 | 🐛 5 | 🌐 JavaScript | 📅 2026-09-04: Simplifies creation of HTML files to serve your bundles.
* [rspack-manifest-plugin](https://github.com/rstackjs/rspack-manifest-plugin) ⭐ 18 | 🐛 1 | 🌐 JavaScript | 📅 2026-09-04: An Rspack plugin for generating an asset manifest.
...
* [@rspack/plugin-preact-refresh](https://github.com/rstackjs/rspack-plugin-preact-refresh) ⭐ 9 | 🐛 3 | 🌐 JavaScript | 📅 2026-09-03: Support Preact Refresh.
...
* [typia-rspack-plugin](https://github.com/colinaaa/typia-rspack-plugin) ⭐ 7 | 🐛 3 | 🌐 TypeScript | 📅 2026-09-03: A Rspack plugin for `typia` - TypeScript transformer for runtime type checking and validation.
...
* [@tailwindcss/webpack](https://github.com/tailwindlabs/tailwindcss/tree/main/packages/%40tailwindcss-webpack) ⭐ 97,443 | 🐛 62 | 🌐 TypeScript | 📅 2026-09-02: A webpack loader for Tailwind CSS v4.
* [@mdx-js/loader](https://github.com/mdx-js/mdx/tree/main/packages/loader) ⭐ 19,767 | 🐛 20 | 🌐 JavaScript | 📅 2026-09-02: Loader for MDX.
...
* [react-compiler-webpack](https://github.com/SukkaW/react-compiler-webpack) ⭐ 121 | 🐛 0 | 🌐 TypeScript | 📅 2026-09-02: The webpack / Rspack loader for React Compiler.
...
* [@vizejs/rspack-plugin](https://github.com/ubugeeei/vize) ⭐ 890 | 🐛 40 | 🌐 Rust | 📅 2026-09-05: High-Performance Vue.js Toolchain in Rust.
...
* [@seed-design/rsbuild-plugin](https://github.com/daangn/seed-design) ⭐ 1,084 | 🐛 68 | 🌐 TypeScript | 📅 2026-09-04: An Rsbuild plugin for the Seed design system.
* [rsbuild-plugin-dts](https://github.com/web-infra-dev/rslib/tree/main/packages/plugin-dts) ⭐ 1,007 | 🐛 30 | 🌐 TypeScript | 📅 2026-09-04: Generate TypeScript declaration files.
* [rsbuild-plugin-tailwindcss](https://github.com/rstackjs/rsbuild-plugin-tailwindcss) ⭐ 54 | 🐛 23 | 🌐 TypeScript | 📅 2026-09-05: An Rsbuild plugin to integrate with Tailwind CSS.
...
* [@rsbuild/plugin-source-build](https://github.com/rstackjs/rsbuild-plugin-source-build) ⭐ 18 | 🐛 3 | 🌐 TypeScript | 📅 2026-09-02: This plugin is designed for the monorepo scenario. It supports referencing source code from other subdirectories and performs build and hot update.
...
* [@rsbuild/plugin-eslint](https://github.com/rstackjs/rsbuild-plugin-eslint) ⭐ 4 | 🐛 3 | 🌐 TypeScript | 📅 2026-09-04: Used to run ESLint checks during the compilation.
...
* [rsbuild-plugin-arethetypeswrong](https://github.com/colinaaa/rsbuild-plugin-arethetypeswrong) ⭐ 3 | 🐛 1 | 🌐 TypeScript | 📅 2026-09-04: Checking TypeScript type definitions with `arethetypeswrong`.
...
* [rsbuild-plugin-mcp](https://github.com/colinaaa/rsbuild-plugin-mcp) ⭐ 3 | 🐛 9 | 🌐 TypeScript | 📅 2026-09-04: Rsbuild plugin that enables a MCP server for your Rsbuild app to provide information about your setup and modules graphs.
...
* [rspress-plugin-giscus](https://github.com/buyfakett/rspress-plugin-giscus) ⭐ 0 | 🐛 0 | 🌐 TypeScript | 📅 2026-02-12: Integrate [giscus](https://github.com/giscus/giscus) ⭐ 12,077 | 🐛 127 | 🌐 TypeScript | 📅 2026-05-26 into Rspress, a comment system powered by GitHub Discussions.
...
* [zod-compiler](https://github.com/gajus/zod-compiler) ⭐ 800 | 🐛 0 | 🌐 TypeScript | 📅 2026-09-02: Compile Zod schemas into zero-overhead validation functions at build time.
...
* [unplugin-element-plus](https://github.com/element-plus/unplugin-element-plus) ⭐ 252 | 🐛 10 | 🌐 TypeScript | 📅 2026-09-03: Import Element Plus on demand.
...
* [@modern-js/adapter-rstest](https://github.com/web-infra-dev/modern.js/tree/main/packages/cli/adapter-rstest) ⭐ 5,039 | 🐛 54 | 🌐 TypeScript | 📅 2026-09-03: Rstest adapter for Modern.js configuration.
* [@rstest/adapter-rspack](https://github.com/web-infra-dev/rstest/tree/main/packages/adapter-rspack) ⭐ 493 | 🐛 52 | 🌐 TypeScript | 📅 2026-09-05: Rstest adapter for Rspack configuration.
* [@rstest/adapter-rsbuild](https://github.com/web-infra-dev/rstest/tree/main/packages/adapter-rsbuild) ⭐ 493 | 🐛 52 | 🌐 TypeScript | 📅 2026-09-05: Rstest adapter for Rsbuild configuration.
* [@rstest/adapter-rslib](https://github.com/web-infra-dev/rstest/tree/main/packages/adapter-rslib) ⭐ 493 | 🐛 52 | 🌐 TypeScript | 📅 2026-09-05: Rstest adapter for Rslib configuration.
...
* [@rspack/dev-server](https://github.com/web-infra-dev/rspack-dev-server) ⭐ 42 | 🐛 4 | 🌐 JavaScript | 📅 2026-09-04: Dev server for Rspack, provides the same API as webpack-dev-server.
* [@rspack/resolver](https://github.com/rstackjs/rspack-resolver) ⭐ 42 | 🐛 20 | 🌐 Rust | 📅 2026-09-04: A Rust port of enhanced-resolve.
* [rspack-chain](https://github.com/rstackjs/rspack-chain) ⭐ 35 | 🐛 2 | 🌐 JavaScript | 📅 2026-09-03: A chaining API to generate and simplify the modification of Rspack configurations.
